...
export default function HomePage() {
  return (
    <>
      {/* ═══════════════════════ HERO ═══════════════════════ */}
      <section className="relative min-h-screen flex flex-col justify-center bg-[#0C0C0C] px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl pt-32 pb-24">
          ...
          <h1 className="mt-8 text-[3.25rem] leading-[1.05] tracking-tight text-white sm:text-7xl lg:text-[5.5rem] [font-family:var(--font-display)] animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
          ...
          {/* Data sources */}
          <div className="mt-24 flex flex-wrap items-center gap-x-10 gap-y-4 border-t border-white/[0.06] pt-8 animate-slide-up-fade" style={{ animationDelay: '400ms' }}>
